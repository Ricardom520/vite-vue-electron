...
var eos = endOfStream;
var fs$2 = require$$1$2; // we only need fs to get the ReadStream and WriteStream prototypes
...
require$$4.promisify(require$$0$1.pipeline);
const appPath = require$$1.app.getAppPath();
require$$1$1.resolve(appPath, "..", "..", "update");
axios.create();
